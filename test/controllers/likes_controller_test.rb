...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { character_id: @like.character_id, pix_id: @like.pix_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { character_id: @like.character_id, pix_id: @like.pix_id } }
